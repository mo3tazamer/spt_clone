...
class User {
  ...
  User copyWith({
    ...
    dynamic permissionGroupId,
      ...
      User(
        ...
        hasAbilityToVisuallyContactWithClient:
            hasAbilityToVisuallyContactWithClient ??
                this.hasAbilityToVisuallyContactWithClient,
        hasAbilityToVocallyContactWithClient:
            hasAbilityToVocallyContactWithClient ??
                this.hasAbilityToVocallyContactWithClient,
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        hasAbilityToVisuallyContactWithClient:
            json["has_ability_to_visually_contact_with_client"],
        hasAbilityToVocallyContactWithClient:
            json["has_ability_to_vocally_contact_with_client"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "has_ability_to_visually_contact_with_client":
            hasAbilityToVisuallyContactWithClient,
        "has_ability_to_vocally_contact_with_client":
            hasAbilityToVocallyContactWithClient,
