...
class AppInputFormatters {
  static final nonArabicAndEnglishNumbersFilter = FilteringTextInputFormatter.deny(
    RegExp(r'[\u0660-\u0669-\u06FF0-9]'),
  );
  ...
  static final nonArabicAndEnglishLetterAndNumbersFilter = FilteringTextInputFormatter.deny(
    RegExp(r'[a-zA-Z\u0600-\u06FF\u0750-\u077F\uFB50-\uFDFF\uFE70-\uFEFF]'),
  );
  static lengthLimitingTextInputFormatter(maxLength) => LengthLimitingTextInputFormatter(maxLength);
