...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ar = {
    ...
    "pleaseEnterTheVerificationCodeSentToYourMobilePhone":
        "فضلا ادخل رمز التحقق المرسل إلى جوالك",
  ...
  static const Map<String, dynamic> en = {
    ...
    "welcome": "welcome",
    "otpMsg":
        "if you do not receive the code, you can resend the code within 20 seconds.",
    ...
    "oneMonthSubscriptionOneMonthFree":
        "One month subscription + one month free",
    "riyals150": "SAR 150",
